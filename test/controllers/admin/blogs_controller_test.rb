...
class Admin::BlogsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_blog" do
    assert_difference("Admin::Blog.count") do
      post admin_blogs_url, params: { admin_blog: { blog_category_id: @admin_blog.blog_category_id, title: @admin_blog.title } }
    end
  ...
  test "should update admin_blog" do
    patch admin_blog_url(@admin_blog), params: { admin_blog: { blog_category_id: @admin_blog.blog_category_id, title: @admin_blog.title } }
